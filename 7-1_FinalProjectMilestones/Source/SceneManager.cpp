...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setFloatValue("lightSources[0].focalStrength", 54.0f);
	m_pShaderManager->setFloatValue("lightSources[0].specularIntensity", 0.2f);

	m_pShaderManager->setVec3Value("lightSources[1].position", -8.5f, 5.0f, 0.5f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.1f, 0.01f, 0.01f);
	...
	m_pShaderManager->setFloatValue("lightSources[1].specularIntensity", 0.810f);

	m_pShaderManager->setVec3Value("lightSources[2].position", 8.0f, 5.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.2f, 0.2f, 0.2f);
	m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", 0.4f, 0.3f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[2].specularColor", 1.0f, 1.0f, 1.0f);
	m_pShaderManager->setFloatValue("lightSources[2].focalStrength", 76.0f);
	m_pShaderManager->setFloatValue("lightSources[2].specularIntensity", 3.2f);
}
/***********************************************************
 *  PrepareScene()
 *
...
void SceneManager::RenderScene()
{
	...
	/****************************************************************/
	//Parking Garage - car 1


	/****************************************************************/
	//Parking Garage - car 2
